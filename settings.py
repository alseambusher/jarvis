...
class Analyzer(gtk.Window):
    ...
    def __init__(self):
        ...
        self.analyzer.set_from_file("res/analyzer_0.png")
    ...
    def update_analyzer(self):
        ...
        self.analyzer.set_from_file("res/analyzer_"+str(self.analyzer_index)+".png")

    def analyze_all(self):
        for i in range(len(self.analyzer_data)):
            img,sequence=gesture.analyzer(self.analyzer_data[i])
            cv.SaveImage("res/analyzer_"+str(i)+".png",img)
Analyzer()
gtk.main()
